		...
		'node_modules/react-dom/cjs/react-dom.production.min.js'(exports) {
				...
				m(b.prototype, {
					...
					stopPropagation: function () {
						...
						a2 &&
							(a2.stopPropagation
								? a2.stopPropagation()
								: typeof a2.cancelBubble !== 'unknown' &&
			...
			var Qd = m({}, ud, {
				key: function (a) {
					...
					return a.type === 'keypress'
						? ((a = od(a)),
						  a === 13 ? 'Enter' : String.fromCharCode(a))
				...
				keyCode: function (a) {
					return a.type === 'keydown' || a.type === 'keyup'
						? a.keyCode
						: 0;
				},
				which: function (a) {
			...
			function Ne() {
				for (
					...
					try {
						var c =
							typeof b.contentWindow.location.href === 'string';
					} catch (d) {
						c = false;
					}
			...
			var Pe =
				fa && 'documentMode' in document && 11 >= document.documentMode;
			var Qe = null;
			var Re = null;
			var Se = null;
			var Te = false;
			...
			function hf(a, b, c, d, e) {
				for (var f = b._reactName, g = []; c !== null && c !== d; ) {
					...
					h.tag === 5 &&
						...
						e
							? ((k = Ob(c, f)),
							  k != null && g.unshift(ef(c, k, h)))
							: e ||
							  ((k = Ob(c, f)),
							  k != null && g.push(ef(c, k, h))));
					c = c.return;
				}
			...
			function Sg(a) {
				...
				function f(b2, c2, d2) {
					...
					if (d2 !== null)
						return (
							(d2 = d2.index), d2 < c2 ? ((b2.flags = 2), c2) : d2
						);
					b2.flags = 2;
					return c2;
				}
				...
				function n(a2, b2, c2, d2, f2) {
					if (b2 === null || b2.tag !== 7)
						return (
							(b2 = Xg(c2, a2.mode, d2, f2)), (b2.return = a2), b2
						);
					b2 = e(b2, c2);
					b2.return = a2;
					return b2;
					...
					function () {
						...
						if (!He(g, a2)) {
							...
							He(n, a2) ||
								(l(a2),
								(a2 = Ig(w)),
								(e.mutableReadLanes |= a2 & e.pendingLanes));
				...
				switch (b.tag) {
					...
					case 4:
						return (
							fh(),
							Ci(b),
							a === null && cf(b.stateNode.containerInfo),
							null
						);
					case 10:
						return rg(b), null;
			...
			yb = function (a, b, c) {
				switch (b) {
					...
					case 'select':
						(b = c.value),
							b != null && fb(a, !!c.multiple, b, false);
				}
			};
			Gb = Wj;
