...
function (_React$Component) {
  ...
  function ClipboardInspector() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ClipboardInspector).apply(this, arguments));
  }

  _createClass(ClipboardInspector, [{
    key: "render_file",
    value: function render_file(file) {
      return file ? _react.default.createElement("table", null, _react.default.createElement("thead", null, _react.default.createElement("tr", null, _react.default.createElement("th", null, "Name"), _react.default.createElement("th", null, "Size"), _react.default.createElement("th", null, "Type"), _react.default.createElement("th", null, _react.default.createElement("a", {
        className: "mdn",
        href: "https://developer.mozilla.org/en-US/docs/Web/API/URL/createObjectURL"
      }, "URL.createObjectURL(file)")))), _react.default.createElement("tbody", null, _react.default.createElement("tr", null, _react.default.createElement("td", null, _react.default.createElement("code", null, file.name)), _react.default.createElement("td", null, _react.default.createElement("code", null, file.size)), _react.default.createElement("td", null, _react.default.createElement("code", null, file.type)), _react.default.createElement("td", null, _react.default.createElement("code", null, _react.default.createElement("a", {
        href: file.url
      }, _react.default.createElement("img", {
        src: file.url
      }))))))) : _react.default.createElement("em", null, "N/A");
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var _this$props = this.props,
          data_transfer = _this$props.data_transfer,
          label = _this$props.label;
      var render_data = null;

      if (event) {
        render_data = {
          data_by_type: Array.from(data_transfer.types).map(function (type) {
          ...
          items: data_transfer.items ? Array.from(data_transfer.items).map(function (item) {
            return {
              kind: item.kind,
              type: item.type,
          ...
          files: data_transfer.files ? Array.from(data_transfer.files).map(function (file) {
            return file_info(file);
          }) : null
        };
      }

      return render_data ? _react.default.createElement("div", {
      ...
      }, "getData(type)")))), _react.default.createElement("tbody", null, render_data.data_by_type.map(function (obj, idx) {
        return _react.default.createElement("tr", {
          key: idx
        }, _react.default.createElement("td", null, _react.default.createElement("code", null, obj.type)), _react.default.createElement("td", null, _react.default.createElement("pre", null, _react.default.createElement("code", null, obj.data || _react.default.createElement("em", null, "Empty string")))));
      ...
      }, "getAsFile()")))), _react.default.createElement("tbody", null, render_data.items.map(function (item, idx) {
        return _react.default.createElement("tr", {
          key: idx
        }, _react.default.createElement("td", null, _react.default.createElement("code", null, item.kind)), _react.default.createElement("td", null, _react.default.createElement("code", null, item.type)), _react.default.createElement("td", null, _this.render_file(item.as_file)));
...
function render(data, label) {
  _reactDom.default.render(_react.default.createElement(ClipboardInspector, {
    data_transfer: data,
    label: label
  }), app_el);
}
